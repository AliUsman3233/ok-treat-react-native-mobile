...
export default function DayCareSettingsScreen({ navigation }) {
    ...
    const fetchSettings = async () => {
        try {
            setIsLoading(true);
            const response = await getServiceSetup('DAY_CARE');
            ...
            console.error('Failed to fetch day care settings:', error);
            setIsExistingData(false);
        } finally {
            setIsLoading(false);
        }
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await upsertServiceSetup('DAY_CARE', settings, true);
            if (response.success) {
                navigation.navigate('ProfileSetup', { completedService: 'dayCare' });
            } else {
                alert('Failed to save settings. Please try again.');
            }
        } catch (error) {
            console.error('Error saving day care settings:', error);
            alert('Failed to save settings. Please try again.');
        } finally {
            setIsSaving(false);
        }
        ...
        <ScreenWrapper noBottomTabs>
            <View style={styles.container}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>Day Care</Text>
                ...
                >
                    ...
                    <View style={styles.titleContainer}>
                        <Text style={styles.pageTitle}>Manage Day Care</Text>
                    </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.fieldGroup}>
                            <Text style={styles.fieldLabel}>What days are you generally available to offer Day Care?</Text>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.fieldGroup}>
                            <Text style={styles.fieldLabel}>What can pet owners expect when Day Care at your home?</Text>
                            <Dropdown
