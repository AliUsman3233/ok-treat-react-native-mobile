...
export default function DropInVisitSettingsScreen({ navigation }) {
    ...
    const fetchSettings = async () => {
        try {
            setIsLoading(true);
            const response = await getServiceSetup('DROP_IN_VISITS');
            ...
            console.error('Failed to fetch drop-in visit settings:', error);
            setIsExistingData(false);
        } finally {
            setIsLoading(false);
        }
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await upsertServiceSetup('DROP_IN_VISITS', settings, true);
            if (response.success) {
                navigation.navigate('ProfileSetup', { completedService: 'dropInVisit' });
            } else {
                alert('Failed to save settings. Please try again.');
            }
        } catch (error) {
            console.error('Error saving drop-in visit settings:', error);
            alert('Failed to save settings. Please try again.');
        } finally {
            setIsSaving(false);
        }
        ...
        <ScreenWrapper noBottomTabs>
            <View style={styles.container}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>Drop-In Visit</Text>
                ...
                >
                    {/* Manage Drop-In Visit Title */}
                    <View style={styles.titleContainer}>
                        <Text style={styles.pageTitle}>Manage Drop-In Visit</Text>
                    </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.fieldGroup}>
                            <Text style={styles.fieldLabel}>What days are you generally available to offer Drop-In Visit?</Text>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.fieldGroup}>
                            <Text style={styles.fieldLabel}>What can pet owners expect when Drop-In Visit at your home?</Text>
                            <Dropdown
