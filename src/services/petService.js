...
export const createPet = async (petData) => {
  try {
    const response = await authApi.post('/api/pets', petData);
...
export const getUserPets = async () => {
  try {
    const response = await authApi.get('/api/pets');
    return response.data;
  } catch (error) {
...
export const getPetById = async (petId) => {
  try {
    const response = await authApi.get(`/api/pets/${petId}`);
    return response.data;
  } catch (error) {
...
export const updatePet = async (petId, petData) => {
  try {
    const response = await authApi.put(`/api/pets/${petId}`, petData);
    return response.data;
  } catch (error) {
...
export const deletePet = async (petId) => {
  try {
    const response = await authApi.delete(`/api/pets/${petId}`);
    return response.data;
  } catch (error) {
...
export const getPetByQRCode = async (qrCode) => {
  try {
    const response = await axios.get(`${API_URL}/api/pets/qr/${qrCode}`);
    return response.data;
  } catch (error) {
